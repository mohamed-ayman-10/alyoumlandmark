                        ...
                        <div class="content content-full">
                            <div class="row justify-content-center">
                                <div dir="{{ app()->getLocale() == 'ar' ? 'rtl' : 'ltr' }}"
                                    class="col-md-8 col-lg-6 col-xl-4 py-4 {{ app()->getLocale() == 'ar' ? 'text-right' : '' }}">
                                    <!-- Header -->
                                        ...
                                        <div class="py-3">
                                            <div class="form-group">
                                                <input type="text"
                                                    ...
                                                    id="login-username" name="username" placeholder="@lang('Username')">
                                                @error('username')
                                            ...
                                            <div class="form-group">
                                                <input type="password"
                                                    ...
                                                    id="login-password" name="password" placeholder="@lang('Password')">
                                                @error('password')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row justify-content-center mb-0">
                                            <div class="col-md-6 col-xl-5">
                                                <button type="submit" class="btn btn-block btn-primary">
                                                    <i class="fa fa-fw fa-sign-in-alt mr-1"></i> @lang('Login')
                                                </button>
                                            </div>
                                        </div>
                                    </form>
