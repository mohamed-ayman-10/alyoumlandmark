                        ...
                        <div dir="{{ app()->getLocale() == 'ar' ? 'rtl' : 'ltr' }}"
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="title_ar" value="{{old('title_ar', $product->title_ar)}}" id=""
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="title_en" value="{{old('title_en', $product->title_en)}}" id=""
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description_ar') is-invalid @enderror" name="description_ar" id="" rows="5"
                                        placeholder="{{ __('Description Ar') }}">{{old('description_ar', $product->description_ar)}}</textarea>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description_en') is-invalid @enderror" name="description_en" id="" rows="5"
                                        placeholder="{{ __('Description En') }}">{{old('description_en', $product->description_en)}}</textarea>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="price" value="{{old('price', $product->price)}}" id="" class="form-control @error('price') is-invalid @enderror"
